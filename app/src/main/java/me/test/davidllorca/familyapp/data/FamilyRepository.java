...
import me.test.davidllorca.familyapp.data.local.MemberDao;
...
public class FamilyRepository implements FamilyDataSource {
     ...
     */
    public synchronized static FamilyRepository getInstance(FamilyDataSource familyLocalDataSource) {
        if (sInstance == null) {
            synchronized (LOCK) {
